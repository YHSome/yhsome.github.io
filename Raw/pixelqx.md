...
![2023年6月6日早上路拍桥兴](../images/posts/2023-6-06/1.jpg)
...
![](../images/posts/pixelqx/1.png)  
然后按照提示注册或登录Microsoft账号即可进入服务器。

## 当然你也可以使用java版登入

只需安装启动器（例如pcl2启动器），进入游戏，选择多人游戏，输入服务器地址以及端口即可直接进入。如图所示：  
![](../images/posts/pixelqx/6.png)

# 施工进展及相关内容展示

2023/8/25  
完成了初一初二及行政楼的占地划线  
![](../images/posts/pixelqx/2.png)

2023/8/26  
完成了办公室、正门前的架空层过道、保安亭、升旗台等相关外饰的设计  
![](../images/posts/pixelqx/3.png)

2023/8/28  
将楼层划分清楚并完成了部分地板的铺设  
![](../images/posts/pixelqx/4.png)  
用指令把各楼层的框架整出来了，并且替换了升旗广场的地板为石砖  
![](../images/posts/pixelqx/5.png)

2023/8/29  
加上一部分的地板。  
![](../images/posts/pixelqx/7.png)

2023/8/30  
完成了初一初二课室的装修  
![](../images/posts/pixelqx/8.png)

2023/9/02  
把初三教学楼、体育馆、生物园、操场的部分占地划线划了出来。  
![](../images/posts/pixelqx/9.png)

之前建造的时候把建筑朝向建错了，刚刚顺便改了回来。  
![](../images/posts/pixelqx/10.png)
