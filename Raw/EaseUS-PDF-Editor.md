...
解压后你会看到一个这样的文件  
![](/blog/../blog/image/2023-6-22/1.PNG)
  2. **打开Setup.exe进行安装**  
安装时记得选繁体中文  
![](/blog/../blog/image/2023-6-22/2.PNG)
  3. **打开安装文件夹**  
这里有一个简便的方法，右键桌面上的快捷方式即可打开文件目录  
![](/blog/../blog/image/2023-6-22/3.PNG)  
如果你是无脑右键安装，亦可以打开以下路径  
`C:\Program Files (x86)\EaseUS\EaseUS PDF Editor\EaseUS PDF Editor.exe`
  4. **将下载解压目录中的“fix”文件夹中的全部文件复制到安装文件夹中**  
![](/blog/../blog/image/2023-6-22/4.PNG)  
记得选择替换目标中的文件  
![](/blog/../blog/image/2023-6-22/5.PNG)  
如果出现访问被拒，请以管理员身份运行  
![](/blog/../blog/image/2023-6-22/6.PNG)
  5. **安装完毕，请愉快使用**
